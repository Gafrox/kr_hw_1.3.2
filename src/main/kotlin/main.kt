fun main() {
    comission("Mastercard", 7000_00.0, 5000_00.0)
}

fun comission(typeCard: String = "Vk Pay", sumTransfer: Double = 0.0, currentTransfer: Double = 0.0) {
    var sumComission = 0.0
    var odds = 75000_00.0 - sumTransfer
    when (typeCard) {
